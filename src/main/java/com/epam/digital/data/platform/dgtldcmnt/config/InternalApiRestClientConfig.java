...
import com.epam.digital.data.platform.dgtldcmnt.decoder.DigitalDocumentErrorDecoder;
...
@Configuration
@EnableFeignClients(clients = {DigitalDocumentServiceInternalApiRestClient.class,
    DigitalDocumentServiceInternalApiV2RestClient.class})
public class InternalApiRestClientConfig {

  @Bean
  public ErrorDecoder digitalDocumentDecoder() {
    return new DigitalDocumentErrorDecoder();
  }
}
